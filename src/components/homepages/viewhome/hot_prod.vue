    ...
    <div v-if="showModal" class="modal-overlay">
      <div class="modal">
        ...
        <div class="modal-content">
          ...
          <div>
            <p><strong>Size:</strong> <span>{{ selectedProduct.SP_size.toLocaleString() }} </span></p>
            <p><strong>Chú ý:</strong> <span>Để xác định size có phù hợp không vui lòng click vào trang <router-link to="/home/chonsize"><b>Cách chọn size</b></router-link> </span></p>
...
export default {
  ...
  methods: {
    async fetchProducts() {
      try {
        const response = await axios.get(`http://localhost:5000/api/top-selling`);
