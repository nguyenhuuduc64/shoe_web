...
export default {
  ...
  data() {
    return {
      ...
      quantity: 1,
      categories: {
        N01: "Giày thể thao nam",
        N02: "Giày tây nam",
        N03: "Sandal nam",
        N04: "Dép nam",
        N05: "Giày thể thao nữ",
        N06: "Sandal nữ",
        N07: "Dép nữ",
        N08: "Balo",
        N09: "Tất",
  ...
  methods: {
    async fetchProducts() {
      try {
        const response = await axios.get(`http://localhost:5000/api/sanpham-theo-nhom/${this.NPS_ma}`);
